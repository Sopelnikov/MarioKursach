...
ICON_DIR = os.path.dirname("C:\Users\ivan\PycharmProjects\MarioKursach\mario")  # Полный путь к каталогу с файлами
...
ANIMATION_JUMP_LEFT = [('%s/mario/jl.png' % ICON_DIR, 100)]
ANIMATION_JUMP_RIGHT = [('%s/mario/jr.png' % ICON_DIR, 100)]
ANIMATION_JUMP = [('%s/mario/j.png' % ICON_DIR, 100)]
ANIMATION_STAY = [('%s/mario/0.png' % ICON_DIR, 100)]
